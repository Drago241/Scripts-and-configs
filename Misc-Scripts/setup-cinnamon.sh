...
# Label: Install packages: chafa, jp2a, imagemagick, cool-retro-term, lxappearance, diodon, rofi, cava, xdotool, mpv, wmctrl, ttf-mscorefonts-installer, polybar, cmatrix, ffmpeg, fzf
...
for pkg in chafa jp2a imagemagick cool-retro-term lxappearance diodon rofi cava xdotool mpv wmctrl ttf-mscorefonts-installer polybar cmatrix ffmpeg fzf; do
