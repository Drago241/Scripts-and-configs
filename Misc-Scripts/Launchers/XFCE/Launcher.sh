...
#
# 🖥 Alacritty Desktop Terminal Widget
#
...
if [[ "$1" == "-h" || "$1" == "--help" ]]; then
cat << EOF
🖥 Alacritty Desktop Widget
Toggleable desktop embedded Alacritty terminal
EOF
exit 0
fi

echo "🖥 Alacritty Desktop Widget"

# =====================================================
# CONFIGURATION
# =====================================================

APPIMAGE="/home/Muhammad-Abdullah/Desktop/kitty-0.14.3-x86_64.AppImage"
CLASS="AlacrittyWallpaper"
CONFIG="$HOME/.config/alacritty/alacritty.toml"
CMD="/home/Muhammad-Abdullah/Linux/Executibles/Misc-Scripts/AppLauncher.sh"
...
PID_FILE="/tmp/alacritty_widget.pid"
...
# =====================================================
get_window() {
xdotool search --class "$CLASS" 2>/dev/null | head -n 1
}
