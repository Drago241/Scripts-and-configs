...
SCRIPT1="/home/mint/Live-Wallpaper.sh"   # e.g., /home/user/scripts/myscript1.sh
SCRIPT2="/home/mint/CAVA-Desktop-Alt/CAVA-Desktop-Alt (1680x1050).sh"   # e.g., /home/user/scripts/myscript2.sh
