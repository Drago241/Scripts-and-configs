...
cp -r "$HOME/Downloads/Linux Customization/Configs/fastfetch" "$HOME/.config/"
cp -r "$HOME/Downloads/Linux Customization/Configs/fish" "$HOME/.config/"
cp -r "$HOME/Downloads/Linux Customization/.conky" $HOME
cp -r "$HOME/Downloads/Linux Customization/Configs/btop" "$HOME/.config/"
cp -r "$HOME/Downloads/Linux Customization/Configs/kando" "$HOME/.config/"
...
cp -r "$HOME/Downloads/Linux Customization/Configs/cava" "$HOME/.config/"
cp -r "$HOME/Downloads/Linux Customization/cinnamon" "$HOME/.local/share"
cp -r "$HOME/Downloads/Linux Customization/Configs/GLAVA/glava" "$HOME/.config/"
cp -r "$HOME/Downloads/Linux Customization/Bash Scripts/Launchers" $HOME
cp -r "$HOME/Downloads/Linux Customization/Configs/polybar" "$HOME/.config/"
cp -r "$HOME/Downloads/Linux Customization/Configs/Wezterm/wezterm" "$HOME/.config/"
cp -r "$HOME/Downloads/Linux Customization/Configs/ghostty" "$HOME/.config/"
cp -r "$HOME/Downloads/Linux Customization/Oh-My-Posh/Custom-Themes" "$HOME/.cache/oh-my-posh/themes/"
...
ROFI_FILES_SETUP="$HOME/Downloads/Linux Customization/Configs/rofi/setup.sh"
