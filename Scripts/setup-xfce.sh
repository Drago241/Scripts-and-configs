...
# Label: Install packages: chafa, jp2a, imagemagick, cool-retro-term, lxappearance, diodon, rofi, cava, xdotool, mpv, wmctrl, ttf-mscorefonts-installer, polybar, cmatrix, eddy, webp-pixbuf-loader, ffmpeg, fzf
...
for pkg in chafa jp2a imagemagick cool-retro-term lxappearance diodon rofi cava xdotool mpv wmctrl ttf-mscorefonts-installer polybar cmatrix eddy webp-pixbuf-loader ffmpeg fzf; do
...
cp -r "$HOME/Linux/Linux-Customization/Configs/fastfetch" "$HOME/.config/"
cp -r "$HOME/Linux/Linux-Customization/Configs/fish" "$HOME/.config/"
cp -r "$HOME/Linux/Linux-Customization/.conky" $HOME
cp -r "$HOME/Linux/Linux-Customization/Configs/btop" "$HOME/.config/"
cp -r "$HOME/Linux/Linux-Customization/Configs/kando" "$HOME/.config/"
...
cp -r "$HOME/Linux/Linux-Customization/Configs/cava" "$HOME/.config/"
cp -r "$HOME/Linux/Linux-Customization/cinnamon" "$HOME/.local/share"
cp -r "$HOME/Linux/Linux-Customization/Configs/GLAVA/glava" "$HOME/.config/"
cp -r "$HOME/Linux/Linux-Customization/Bash Scripts/Launchers" $HOME
cp -r "$HOME/Linux/Linux-Customization/Configs/polybar" "$HOME/.config/"
cp -r "$HOME/Linux/Linux-Customization/Configs/Wezterm/wezterm" "$HOME/.config/"
cp -r "$HOME/Linux/Linux-Customization/Configs/ghostty" "$HOME/.config/"
