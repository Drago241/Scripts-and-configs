...
# ================= HELP SECTION (ADDED) =================
function show_help {
	echo "Window Management Script"
	echo ""
	echo "Usage:"
	echo "  $0 [command]"
	echo ""
	echo "Available Commands:"
	echo "  tile        - Tile all visible windows in a grid layout"
	echo "  tiletwo     - Select two windows and tile them side-by-side"
	echo "  cascade     - Arrange windows in cascading layout"
	echo "  select      - Temporarily tile windows to help select one"
	echo "  showdesktop - Toggle minimize/restore all windows"
	echo ""
	echo "Help:"
	echo "  help, -h, --help   - Show this help message"
	echo ""
	echo "Requirements:"
	echo "  xdotool, wmctrl, bc, x11-utils"
	echo ""
}
# ========================================================
